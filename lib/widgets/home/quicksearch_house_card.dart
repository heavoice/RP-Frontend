...
class QuickSearchHouseCard extends ConsumerStatefulWidget {
  final Map<String, dynamic> house;
  final VoidCallback? onRemove;

  const QuickSearchHouseCard({
    super.key,
    required this.house,
    this.onRemove,
  });
  ...
  @override
  ConsumerState<QuickSearchHouseCard> createState() =>
      _QuickSearchHouseCardState();
}

class _QuickSearchHouseCardState extends ConsumerState<QuickSearchHouseCard> {
  bool isHover = false;
  ...
  Widget build(BuildContext context) {
    ...
    final booking = house['booking'];
    final String bookedBy = booking?['user']?['name'] ?? 'Belum ada';
